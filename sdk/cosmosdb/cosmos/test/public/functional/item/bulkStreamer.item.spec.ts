...
// describe("BulkStreamer", async function () {
...
//           let executionPromises = bulkStreamer.execute(operations);
...
//           executionPromises = bulkStreamer.execute([operation]);
...
//         const executionPromises = bulkStreamer.execute(operations);
...
//             promises.push(...bulkStreamer.execute([operation.operation])),
//           );
//           const response = await Promise.all(promises);
//           bulkStreamer.dispose();
...
//       //   const bulkStreamer = container.items.getBulkStreamer();
//       //   const executionResults = bulkStreamer.execute(operations);

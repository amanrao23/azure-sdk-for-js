...
export class CosmosClient {
  ...
  private clientCredential?: ClientSecretCredential;
  ...
  constructor(optionsOrConnectionString: string | CosmosClientOptions) {
    ...
    this.clientCredential = optionsOrConnectionString?.clientSecretCredential;
    if (
    ...
    this.databases = new Databases(this, this.clientContext, this?.clientCredential);
  ...
  public database(id: string): Database {
    return new Database(this, id, this.clientContext, this?.clientCredential);
  }

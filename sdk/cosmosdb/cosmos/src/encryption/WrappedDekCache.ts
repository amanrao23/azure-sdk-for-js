...
export class WrappedDekCache {
  ...
  private dataEncryptionKeyCache: { [key: string]: { value: [string, EncryptionKeyWrapMetadata] } } = {};

  constructor() {
    this.dataEncryptionKeyCache = {};
  }

  public setDataEncryptionKey(key: string, wrappedKey: string, encryptionKeyWrapMetadata: EncryptionKeyWrapMetadata) : void  {
